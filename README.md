...
The vast majority of code implemented before 5/1/2026 is licensed under [MIT](https://github.com/space-wizards/space-station-14/blob/master/LICENSE.TXT).

All code implemented post 4/30/2026 is licensed under an [AGPL 3.0 License](https://www.gnu.org/licenses/agpl-3.0.en.html) unless noted otherwise.
